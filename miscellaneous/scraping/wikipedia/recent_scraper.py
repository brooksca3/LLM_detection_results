...
def main():
    ...
    article_limit = 10000  # Set your desired number of articles
    ...
    for article_title, article_url in tqdm(articles, desc="Scraping articles"):
        content = scrape_wikipedia_article(article_title)
        if content:
            data.append({
                'title': article_title,
                'url': article_url,
    ...
    print(f"Scraped data has been saved to 'scraped_articles.json'")
